...
#undef DUK_USE_ARRAY_BUILTIN
#undef DUK_USE_ARRAY_PROP_FASTPATH
#undef DUK_USE_ASSERTIONS
#undef DUK_USE_BOOLEAN_BUILTIN
...
#undef DUK_USE_FUNCTION_BUILTIN
#undef DUK_USE_GLOBAL_BUILTIN
#undef DUK_USE_HSTRING_ARRIDX
#undef DUK_USE_HSTRING_LAZY_CLEN
#undef DUK_USE_INTERRUPT_COUNTER
#undef DUK_USE_JSON_BUILTIN
#undef DUK_USE_MATH_BUILTIN
#undef DUK_USE_NUMBER_BUILTIN
#undef DUK_USE_OBJECT_BUILTIN
